...
namespace BlazorApp1.Data
{
    public class Teams
    {
        ...
        public Teams()
        {
            ...
            Team sabiha = new Team("Salman", "Chishti", "Co-founder of zuvmeco, MSP ", "https://pbs.twimg.com/profile_images/1237997999848112128/afh2nqnU_400x400.jpg");
            Team sunder = new Team("Sunder", "Eshwar", "MSP", "https://pbs.twimg.com/profile_images/996210938746372096/FcxJdvpu_400x400.jpg");
            teams.Add(salman);
            teams.Add(dawood);
            teams.Add(sabiha);
            teams.Add(sunder);
